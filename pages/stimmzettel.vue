...
<template>
  ...
  <div class="d-print-none mb-4">
    ...
    <p>Trage hier die Kandidierenden <b>in der vom Wahlausschuss ausgelosten zufälligen Reihenfolge</b> nacheinander ein.</p>
  ...
  <div class="card">
    ...
    <div class="card-footer" v-if="propDE.extraBallotLine">
